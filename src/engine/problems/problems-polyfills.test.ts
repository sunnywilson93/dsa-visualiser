...
const categories = ['array-polyfills', 'functional-js', 'object-utils'] as const
const problems = categories.flatMap(cat => getProblemsForCategory(cat))

// Deduplicate in case a problem belongs to multiple listed categories
...
describe('Polyfills & Functional Problems', () => {
