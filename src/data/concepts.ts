...
// Subcategories for 'fundamentals' category (UX organization)
export const subcategories: Record<string, { name: string; description: string; order: number }> = {
  'scope-hoisting': {
    name: 'Scope & Hoisting',
    description: 'Understanding variable scope, hoisting, and closures',
    order: 1
  },
  'async-patterns': {
  ...
  'array-methods': {
    name: 'Array Methods',
    description: 'Working with JavaScript arrays and iteration methods',
    order: 3
  },
  'prototypes-oop': {
    name: 'Prototypes & OOP',
    description: 'Prototype inheritance, classes, and object-oriented patterns',
    order: 4
  },
  'modern-js': {
    name: 'Modern JavaScript',
    description: 'ES6+ features: destructuring, spread, optional chaining',
    order: 5
  },
  'event-loop': {
