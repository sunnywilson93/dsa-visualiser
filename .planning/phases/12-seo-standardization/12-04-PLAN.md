...
<task type="auto">
  <name>Task 2: Create OG images for concept and category pages</name>
  <files>src/app/concepts/[conceptId]/opengraph-image.tsx, src/app/[categoryId]/opengraph-image.tsx</files>
  <action>
...
```bash
# Both files exist
ls src/app/concepts/[conceptId]/opengraph-image.tsx src/app/[categoryId]/opengraph-image.tsx
...
```
  ...
  <done>
- JS concept page OG shows concept title
- Category page OG shows category name and problem count
- Both use consistent design (dark gradient, accent color, site branding)
- Build succeeds with new OG image files
  </done>
</task>
...
5. Validate with social share preview tool
</verification>
